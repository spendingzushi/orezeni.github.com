...
OpenSpending.Styles.Cofog = {
  ...
  /* zushi cofog */
  '1': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#935B3B' },
  '1-1': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#935B3B' },
  '2': { icon: 'icons/machi.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-1': { icon: 'icons/machi.svg', color: '#C75746', bcolor: '#0AB971' },
//  '2-2': { icon: 'icons/education.svg', color: '#C75746', bcolor: '#0AB971' },
  '3': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#4E6D00' },
  '3-1': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#4E6D00' },
//  '3-2': { icon: 'icons/harbor.svg', color: '#C75746', bcolor: '#4E6D00' },
//  '3-3': { icon: 'icons/culture.svg', color: '#C75746', bcolor: '#4E6D00' },
  '4': { icon: 'icons/c_watersup.svg', color: '#C75746', bcolor: '#D33673' },
  '4-1': { icon: 'icons/c_watersup.svg', color: '#C75746', bcolor: '#D33673' },
...
//  '8-2': { icon: 'icons/government.svg', color: '#C75746', bcolor: '#C75746' },
  '9': { icon: 'icons/schools.svg', color: '#C75746', bcolor: '#D33673' },
  '9-1': { icon: 'icons/pre-school.svg', color: '#C75746', bcolor: '#D33673' },
  '10': { icon: 'icons/publicaffairs.svg', color: '#C75746', bcolor: '#790586' },
  '10-1': { icon: 'icons/publicaffairs.svg', color: '#C75746', bcolor: '#790586' },
  '11': { icon: 'icons/japanese-money.svg', color: '#C75746', bcolor: '#790586' },
  '11-1': { icon: 'icons/japanese-money.svg', color: '#C75746', bcolor: '#790586' }
};
